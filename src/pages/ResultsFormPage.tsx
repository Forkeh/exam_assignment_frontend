...
export default function ResultsFormPage() {
  const [participants, setParticipants] = useState<IParticipantFull[] | null>(
    null,
  );
  ...
  const resultType = disciplines?.find(
    (discipline) => discipline.id === Number(disciplineSelected),
  )?.resultType;

  const selectedParticipantDisciplines = participants?.find(
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectGroup>
                            {selectedParticipantDisciplines?.map(
                              (discipline) => (
                                <SelectItem
                                  key={discipline.id}
            ...
            {disciplineSelected && (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      Result {resultTypeDictionary(resultType)}
                    </FormLabel>
                    <FormControl>
                      <Input
